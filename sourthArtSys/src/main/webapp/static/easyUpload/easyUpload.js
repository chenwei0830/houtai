    ...
    this.each(function (index, element) {
      ...
      var easyManager = {
        init: function () {
          ...
          // $html += option.multi ? '<span class="easy_upload_head_btn1
			// noselect">上传</span>' : '';
          // $html += option.multi ? '<span class="easy_upload_head_btn2
			// noselect">删除</span>' : '';
         // $html += option.multi ? '<i class="easyUploadIcon noselect
			// head_check" data-checked="no">&#xe693;</i>' : '';
        ...
        _renderFile: function (fileArr, target) {
          ...
          function render(file) {
           ...
           // $html += option.multi ? '<i class="easyUploadIcon noselect
			// queue_check queue_check_allow_'+ file.allow +'" data-checked="no"
			// data-up="1">&#xe693;</i>' : '';
            $html += '</div>';
            if (option.multi) {
              $(queueUl).append($html);
