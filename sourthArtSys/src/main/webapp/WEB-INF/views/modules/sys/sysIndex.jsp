...
<body>
	<div id="main">
			...
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<li id="userInfo" class="dropdown">
						<a class="dropdown-toggle">您好, ${fns:getUser().nickName}</a>
					</li>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid" style="border-top: 1px solid #2fa4e7;">
				<a>${fns:getConfig('productName')}-${fns:getConfig('version')}</a>
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
