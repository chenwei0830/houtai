...
<!-- 	</ul> -->
	<form:form id="searchForm" action="${ctx}/sys/log/" method="post" class="breadcrumb form-search">
		...
		<div>
			...
			<label>用户登录名/微信号：</label><input id="createBy.loginName" name="createBy.loginName" type="text" maxlength="50" class="input-mini" value="${log.createBy.loginName}"/>
